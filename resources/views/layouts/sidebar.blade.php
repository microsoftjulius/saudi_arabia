        ...
        <div class="navbar-content scroll-div" >
            ...
            <div class="card text-center">
                <div class="card-block">
                    ...
                    <h6 class="mt-3">You licence is still on</h6>
                    <p>You license is valid for a year</p>
                    <a href="#!" target="_blank" class="btn waves-effect waves-light btn-gradient-primary wave-effect waves-light btn-sm text-white m-0">Pay for more licence</a>
                </div>
            </div>
